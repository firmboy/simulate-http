 ...
 * @Version 1.0
 **/
public class SpringBootMemoryClassLoader extends URLClassLoader {
     ...
     * 单利默认的
     */
    private static final SpringBootMemoryClassLoader defaultLoader = new SpringBootMemoryClassLoader();

    public SpringBootMemoryClassLoader() {
        super(new URL[0], SpringBootMemoryClassLoader.class.getClassLoader());
    }
     ...
     * @return 类加载器对象
     */
    public static SpringBootMemoryClassLoader getInstrance() {
...
class MemoryJavaFileManager extends ForwardingJavaFileManager<JavaFileManager> {
    ...
    public void init() {
        try {
            String jarBaseFile = SpringBootMemoryClassLoader.getPath();
    ...
    public Iterable<JavaFileObject> list(Location location,
        ...
        if ("CLASS_PATH".equals(location.getName()) && SpringBootMemoryClassLoader.isJar()) {
